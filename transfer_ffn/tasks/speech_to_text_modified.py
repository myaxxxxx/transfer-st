...
from transfer.datasets.speech_to_text_dataset import (
    S2TDataConfig,
    SpeechToTextDataset,
...
@register_task("speech_to_text_modified_multi")
class SpeechToTextTaskModifiedMulti(LegacyFairseqTask):
    @classmethod
    ...
    def setup_task(cls, args, **kwargs):
        ...
        lang_list = open(args.lang_pair_list, 'r', encoding='utf-8')
        for line in lang_list:
            line = line.strip()
            print(line)
            # src_dict.add_symbol("__" + line + "__")
            tgt_dict.add_symbol("__" + line + "__")
    ...
    def load_dataset(self, split, epoch=1, combine=False, **kwargs):
        ...
        # self.datasets[split].tgt_langs = "__ro__"
    ...
    def build_model(self, args, from_checkpoint=False):
        ...
        return super(SpeechToTextTaskModifiedMulti, self).build_model(args, from_checkpoint)
    ...
    def build_generator(
        ...
        self.BOS_id = self.tgt_dict.index("__ro__")
        # self.data_cfg.prepend_tgt_lang_tag = BOS_id
        # extra_gen_cls_kwargs["symbols_to_strip_from_output"] = bos_id
        # extra_gen_cls_kwargs["bos"] = bos_id
        # print(args.eos_token)
        # print(lang_token_ids)
        # exit()
        
        test = super().build_generator(
    ...
    def inference_step(
        ...
        # print(666)
        # print(prefix_tokens)
        # prefix_tokens = self.BOS_id
        # exit()
        with torch.no_grad():
            return generator.generate(
                models, sample, prefix_tokens=prefix_tokens, constraints=constraints, bos_token=self.BOS_id
            )
